...
func TestPhase7ConfigurationMatrixGoldenContract(t *testing.T) {
	...
	wantOwners := map[string]string{
		"AJIASU_ENVIRONMENT":                      "control-plane",
		"AJIASU_RELEASE_MANIFEST":                 "release",
		"AJIASU_ENVIRONMENT_ID":                   "lifecycle",
		"AJIASU_HEALTH_ENDPOINT":                  "lifecycle",
		"AJIASU_HEALTH_TIMEOUT":                   "lifecycle",
		"AJIASU_MIGRATIONS_DIRECTORY":             "lifecycle",
		"AJIASU_MIGRATION_TIMEOUT":                "lifecycle",
		...
		"AJIASU_ROUTE_SIGNING_KEY_FILE":           "control-plane",
		"AJIASU_GATEWAY_HTTP_LISTEN":              "gateway",
		"AJIASU_GATEWAY_NAME":                     "gateway",
		"AJIASU_GATEWAY_SOCKS5_LISTEN":            "gateway",
		"AJIASU_GATEWAY_CONTROL_PLANE_ENDPOINT":   "gateway",
		"AJIASU_GATEWAY_RELAY_ENDPOINT":           "gateway",
		"AJIASU_GATEWAY_ROUTE_VERIFYING_KEY_FILE": "gateway",
		"AJIASU_GATEWAY_CERTIFICATE_FINGERPRINT":  "gateway",
		"AJIASU_GATEWAY_CA_FILE":                  "gateway",
		"AJIASU_GATEWAY_CERT_FILE":                "gateway",
		"AJIASU_GATEWAY_KEY_FILE":                 "gateway",
		"AJIASU_GATEWAY_STATE_DIRECTORY":          "gateway",
		"AJIASU_GATEWAY_MAX_HEADER_BYTES":         "gateway",
		"AJIASU_GATEWAY_MAX_CONNECTIONS":          "gateway",
		...
		"AJIASU_AGENT_RELAY_CERT_FILE":            "agent",
		"AJIASU_AGENT_RELAY_KEY_FILE":             "agent",
		"AJIASU_AGENT_RELAY_CLIENT_CA_FILE":       "agent",
		"AJIASU_AGENT_RELAY_DIRECTORY":            "agent",
		"AJIASU_AGENT_ROUTE_VERIFYING_KEY_FILE":   "agent",
		"AJIASU_AGENT_ENROLLMENT_TOKEN_FILE":      "agent",
		"AJIASU_AGENT_RUNNER_IMAGE":               "agent",
		"AJIASU_AGENT_RUNTIME":                    "agent",
		"AJIASU_AGENT_VERSION":                    "agent",
		"AJIASU_AGENT_SHUTDOWN_TIMEOUT":           "agent",
